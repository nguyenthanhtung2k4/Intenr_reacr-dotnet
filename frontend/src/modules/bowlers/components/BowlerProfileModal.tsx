        ...
        >
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
                <button
                  onClick={() => {
                    onClose();
                    navigate(`/teams/${bowler.teamId}`);
                  }}
                  className="bg-slate-50 rounded-lg px-4 py-3 hover:bg-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 text-left w-full"
                >
              ...
              <div className="bg-slate-50 rounded-lg px-4 py-3 hover:bg-slate-100 hover:shadow-sm transition-all duration-300">
              ...
              <div className="bg-slate-50 rounded-lg px-4 py-3 md:col-span-2 hover:bg-slate-100 hover:shadow-sm transition-all duration-300">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-100 hover:bg-blue-100 hover:-translate-y-1 hover:shadow-md transition-all duration-300 cursor-default">
              ...
              <div className="bg-emerald-50 rounded-lg p-4 border border-emerald-100 hover:bg-emerald-100 hover:-translate-y-1 hover:shadow-md transition-all duration-300 cursor-default">
                <p className="text-[11px] font-bold uppercase text-emerald-700">Average</p>
                <p className="text-2xl font-black text-slate-900">
                  {stats?.averageScore?.toFixed(1) || '0.0'}
                </p>
              </div>
              <div className="bg-purple-50 rounded-lg p-4 border border-purple-100 hover:bg-purple-100 hover:-translate-y-1 hover:shadow-md transition-all duration-300 cursor-default">
              ...
              <div className="bg-amber-50 rounded-lg p-4 border border-amber-100 hover:bg-amber-100 hover:-translate-y-1 hover:shadow-md transition-all duration-300 cursor-default">
